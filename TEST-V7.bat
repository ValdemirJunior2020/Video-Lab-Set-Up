...
if not exist "%VENV%\Scripts\python.exe" (
  echo [TEST] Creating isolated Playwright test environment...
...
echo [TEST] Running Docker, Ollama, Piper, Pexels and Playwright checks...
"%VENV%\Scripts\python.exe" "%~dp0VERIFY-V7.py" "%MPT%"
exit /b %ERRORLEVEL%
